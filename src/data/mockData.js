...
export const INITIAL_ADMIN_SETTINGS = {
  ...
  supportContact: 'support@renttocent.in',
...
export const INITIAL_LEGAL_CONFIG = {
  ...
  legalPolicyNote: 'IMPORTANT LEGAL NOTICE: Regulatory guidelines for peer-to-peer motor vehicle sharing operate under owner authorization & verified documents (RC, Commercial/Self-drive permit where applicable). Rent to Cent acts as a platform connecting local owners and pilgrims.',
