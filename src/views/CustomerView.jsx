          ...
          <section className="relative bg-gradient-to-r from-slate-950 via-teal-950 to-slate-950 text-white py-12 sm:py-20 px-4 overflow-hidden border-b border-teal-900/50">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="max-w-3xl mb-8">
                ...
                <h1 className="font-heading text-4xl sm:text-6xl font-extrabold tracking-tight text-white mb-4 leading-tight">
                  Rent a Bike in Vrindavan
                </h1>

                <p className="text-slate-300 text-sm sm:text-lg leading-relaxed mb-8 font-normal max-w-2xl">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-sm py-3.5 px-7 rounded-xl flex items-center gap-2 shadow-lg shadow-emerald-600/30 transition-transform active:scale-95"
                  >
                    <VrindavanScooterIcon className="w-5 h-5 text-white" strokeWidth={2.2} />
                    <span>Browse Bikes</span>
                  </button>

                  <button
                    onClick={() => setRole('owner')}
                    className="bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-sm py-3.5 px-6 rounded-xl flex items-center gap-2 shadow-md transition-transform active:scale-95"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-[#25D366] hover:bg-[#20ba5a] text-white font-extrabold text-sm py-3.5 px-6 rounded-xl flex items-center gap-2 shadow-md transition-transform active:scale-95"
                  >
